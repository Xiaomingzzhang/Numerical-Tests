...
save("E://Tex Files//Computing invariant manifolds in non-smooth dynamical systems//figs//impactsystem_period.png", fig1, pt_per_unit=2.0, px_per_unit=2.0)
save("E://Tex Files//Computing invariant manifolds in non-smooth dynamical systems//figs//impactsystem_contact_global.png", fig2, pt_per_unit=2.0, px_per_unit=2.0)
save("E://Tex Files//Computing invariant manifolds in non-smooth dynamical systems//figs//impactsystem_contact_near_hyper.png", fig3, pt_per_unit=2.0, px_per_unit=2.0, update=false)
end